...
namespace VowApp2
{
	...
	{
		// events
		public event EventHandler<VowServiceConnectedEventArgs> LocationServiceConnected = delegate {};

		// declarations
		protected readonly string logTag = "App";
		protected VowLocationServiceConnection locationServiceConnection;
		...
		public VowLocationService LocationService
		{
			get {
		...
		protected App () 
		{
			...
			new Task ( () => { 
				...
				Android.App.Application.Context.StartService (new Intent (Android.App.Application.Context, typeof(VowLocationService)));

				// create a new service connection so we can get a binder to the service
				this.locationServiceConnection = new VowLocationServiceConnection (null);

				// this event will fire when the Service connectin in the OnServiceConnected call 
				this.locationServiceConnection.ServiceConnected += (object sender, VowServiceConnectedEventArgs e) => {
				...
				Intent locationServiceIntent = new Intent (Android.App.Application.Context, typeof(VowLocationService));
